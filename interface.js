...
`var c = new Interface.Piano({ 
  ...
  startletter : "C",
   ...
   noteLabels : true, 
   target: synth,
   onvaluechange : function() {this.target.note (this.frequency, this.value); this.label; this.octave},
});
panel = new Interface.Panel();
panel.add(a);
`
...
/**###Interface.Piano.sharpsOnly : property
If true, the key labels will not have the flat alternative, only the sharp. (e.g. "C#"" instead of "C#/Db")
**/
  ...
  {    
    ...
    _init : function() {
      var x = this._x(),
          ...
          keylabel = this.sharpsOnly ? keyid : ["0","C","C#/Db","D","D#/Eb","E","F","F#/Gb","G","G#/Ab","A","A#/Bb","B"],
